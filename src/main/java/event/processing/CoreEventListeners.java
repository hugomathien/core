...
public class CoreEventListeners {
	...
	public void logEvent(Event event) {
		CoreConfig.logger.log(Level.TRACE, "Received @"+ event.toString());
	}
	...
	public void portfolioComposition(PortfolioCompositionEvent event) {
		event.getPortfolio().updateComposition(event); // TODO: Needs to also remove members otherwise it creates an expanding universe (make that optional) !
	}
	...
	public void timerEvent(TimerEvent event) throws DataQueryException,DataServiceStartException {
		CoreConfig.logger.log(Level.INFO, "Received TimerEvent @"+ event.toString());
